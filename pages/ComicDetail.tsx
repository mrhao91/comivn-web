...
const ComicDetail: React.FC = () => {
  ...
  const renderDescription = () => {
      ...
      if (!shouldTruncate || isDescExpanded) {
          return (
              <div className="prose prose-invert max-w-none text-slate-300 leading-relaxed text-sm md:text-base animate-in fade-in duration-300">
                  {description.split('\n').map((line, i) => (
      ...
      return (
          <div className="text-slate-300 leading-relaxed text-sm md:text-base relative">
    ...
    <div className="pb-10 bg-darker min-h-screen">
        ...
        <div className="container mx-auto px-4 -mt-64 relative z-10">
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-12">
                ...
                <div className="flex-grow pt-4 md:pt-12 text-center md:text-left text-white">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-slate-300 mb-8 p-4 bg-white/5 rounded-xl border border-white/5 inline-flex">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Left Column: Content & Chapters */}
                <div className="lg:col-span-2 space-y-8">
                    {/* Description */}
                    <section className="bg-card rounded-2xl border border-white/10 p-6 shadow-xl relative">
                        <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2 border-b border-white/5 pb-3">
                            <BookOpen className="text-primary"/> Nội dung truyện
                        </h2>
                        
                        {renderDescription()}

                        {comic.description && comic.description.length > 300 && (
                            <div className="flex justify-center mt-2">
                                <button 
                                    onClick={() => setIsDescExpanded(!isDescExpanded)}
                                    className="flex items-center gap-1 text-primary hover:text-primary/80 font-medium text-sm transition-colors px-4 py-1 rounded-full hover:bg-primary/10"
                                >
                                    {isDescExpanded ? (
